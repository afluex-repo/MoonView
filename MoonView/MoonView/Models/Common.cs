...
namespace MoonView.Models
{
    ...
    {
        public static string CompanyName = "MoonView InfraTech";
        public static string CompanyAddress = "MoonView Shop No. 130,Shopping Square-2, Sector-D, Sushant Golf City";
